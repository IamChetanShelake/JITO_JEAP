...
<head>
    ...
    <title>3rd Stage Document Reminder</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 32px 24px; color: #333333;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.5;">
                                This is a reminder to submit your 3rd Stage Documents. Your second disbursement is scheduled on
                                <strong>{{ $secondDisbursementDate->format('d M Y') }}</strong>.
                            </p>
                            <p style="margin: 0 0 24px; font-size: 14px; line-height: 1.5; color: #666666;">
                                Please log in to your student panel and upload the required documents at the earliest.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
