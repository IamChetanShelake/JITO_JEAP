            ...
            <div class="report-header">
                ...
                @if (!$renderForPdf)
                    <div class="report-actions">
                        <form class="date-filter" method="GET" action="{{ route('admin.reports.financial_graph_report') }}">
                            <label>
                                <span>From</span>
        ...
        <script>
            ...
            new Chart(document.getElementById('financialChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Amount (Cr)',
                        data: [financialSummary.donations, financialSummary.sanctioned, financialSummary
                            .disbursed
                        ],
