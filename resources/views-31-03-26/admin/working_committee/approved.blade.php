...
@section('title', 'Working Committee - Approved Forms - JitoJeap Admin')
...
@section('content')
    <div class="page-header">
        <div class="page-title-section">
            <h1 class="page-title">
                ...
                Working Committee - Approved Forms
            </h1>
            <p class="page-subtitle">List of approved user forms from working committee stage</p>
        </div>
    ...
    <div class="card">
        <div class="card-body" style="padding: 1.5rem; border-bottom: 1px solid var(--border-color);">
            <form method="GET" action="{{ route('admin.working_committee.approved') }}" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-4">
