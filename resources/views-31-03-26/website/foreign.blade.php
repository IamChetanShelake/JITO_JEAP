                            ...
                            <tbody id="tableBody">
                                ...
                                <tr class="tableRow">
                                    <td
                                        ...
                                        {{ $index + 1 }}</td>
                                    <td
                                        style="padding: 12px; border-left: none; border-right: 4px solid white; border-bottom: 1px solid #ddd; font-family: 'Poppins'; font-size: 14px;">
                                        {{ $university->university_name }}</td>
                                    <td
                                        style="padding: 12px; border-left: none; border-right: 4px solid white; border-bottom: 1px solid #ddd; font-family: 'Poppins'; font-size: 14px;">
                                        {{ $university->country ?? 'N/A' }}</td>
