                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-field">
                                            ...
                                            @endphp
                                            <input type="text" class="form-input" value="{{ $marksheetLabel }}"
                                                readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="form-section">
                                    <div class="form-row">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input"
                                                value="{{ $user->educationDetail->organization_name ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="form-field">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input"
                                                value="{{ $user->educationDetail->duration_start_year ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label">Duration End Year</label>
                                            <input type="text" class="form-input"
                                                value="{{ $user->educationDetail->duration_end_year ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label">Work Location City</label>
                                            <input type="text" class="form-input"
                                                value="{{ $user->educationDetail->work_location_city ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="form-field">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input"
                                                value="{{ $user->educationDetail->yearly_gross_income ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
