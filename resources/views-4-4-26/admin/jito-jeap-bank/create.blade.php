...
@section('title', 'Add Bank Details - JitoJeap Admin')
...
<div class="create-card">
    <div class="create-header">
        <h1><i class="fas fa-university me-2"></i> Add Bank Details</h1>
        <p class="subtitle">Create new bank account details</p>
    </div>

    <div class="create-card-body">
        <form action="{{ route('admin.jito-jeap-banks.store') }}" method="POST">
            @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('account_number') is-invalid @enderror"
                               id="account_number" name="account_number" value="{{ old('account_number') }}" min="1" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror"
                               id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code') }}" required>
                        @error('ifsc_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
