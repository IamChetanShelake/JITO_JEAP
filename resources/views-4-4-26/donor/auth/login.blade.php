...
@section('content')
        ...
        <div class="container-fluid"
            ...
            <div class="row w-100 justify-content-center align-items-center mt-4">
                <div class="col-md-5 offset-md-1 mb-5 mb-md-0 text-start">
                    ...
                    <h4 class="fw-bold mb-3" style="font-size:25px;font-weight:500;color:#4C4C4C;">Donor Portal</h4>
                    <p class="text-muted mb-4" style="font-size:19px;font-weight:500; text-align:justify;">
                        Welcome to the JITO JEAP donor portal. Log in to view your dashboard and upcoming features.
                    </p>
                    <ul class="list-unstyled text-muted">
                        <li class="mb-2" style="font-size:19px;font-weight:500;">
                            <img src="{{ asset('user/blueicon.png') }}" alt="" style="width:5%;">
                            Secure access to your donor account
                        </li>
                        <li class="mb-2" style="font-size:19px;font-weight:500;">
                            <img src="{{ asset('user/blueicon.png') }}" alt="" style="width:5%;">
                            Manage donations and updates
                        </li>
                        <li class="mb-2" style="font-size:19px;font-weight:500;">
                            <img src="{{ asset('user/blueicon.png') }}" alt="" style="width:5%;">
                    ...
                    <div class="card shadow-md border-0 p-4 rounded-4"
                        ...
                        <div class="card-body">
                            <h4 class="fw-semibold mb-1 text-start" style="font-size:28px; font-weight:500;color:#4C4C4C;">
                                Donor Login</h4>
                            <p class="text-muted text-start mb-4" style="font-size:19px;">Log in to your donor dashboard</p>
                            ...
                            <form method="POST" action="{{ route('donor.login.submit') }}">
                                ...
                                <p class="text-center mt-3 small text-muted" style="font-size:19px;">
                                    Don't have an account? <a href="{{ route('donor.register') }}"
    ...
    <div class="mobile-login-container d-lg-none">
        ...
        <div class="mobile-form-container">
            <h3 class="mobile-form-title">Donor Login</h3>
            <p class="mobile-form-subtitle">Log in to your donor dashboard</p>
            ...
            <form method="POST" action="{{ route('donor.login.submit') }}">
                ...
                <p class="register-link">
                    Don't have an account? <a href="{{ route('donor.register') }}">Create Account</a>
                </p>
            </form>
        </div>

        <div class="mobile-info-section">
            <h4 class="mobile-info-title">Donor Portal</h4>
            <p class="mobile-info-text">
                Log in to access your donor dashboard. More features are coming soon.
            </p>

            <div class="mobile-info-list">
                <div class="mobile-info-item">
                    <img src="{{ asset('user/blueicon.png') }}" alt="" class="mobile-info-icon">
                    <span>Secure donor access</span>
                </div>
                <div class="mobile-info-item">
                    <img src="{{ asset('user/blueicon.png') }}" alt="" class="mobile-info-icon">
                ...
                <div class="mobile-info-item">
                    <img src="{{ asset('user/blueicon.png') }}" alt="" class="mobile-info-icon">
                    <span>Coming soon: donation history</span>
                </div>
            </div>
        </div>
    </div>
