...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleFamilyTable() {
            ...
            <td ><input type="text" name="family_${i}_name" class="form-control" value="${oldData ? oldData.name || '' : ''}" style="width:300px;" required></td>
            <td><input type="number" name="family_${i}_age" class="form-control" value="${oldData ? oldData.age || '' : ''}" required></td>
            <td>
            ...
            <td><input type="text" name="family_${i}_qualification" class="form-control" value="${oldData ? oldData.qualification || '' : ''}" required></td>
            <td>
            ...
            <td><input type="tel" name="family_${i}_mobile" class="form-control" value="${oldData ? oldData.mobile || '' : ''}" required></td>
            <td><input type="email" name="family_${i}_email" class="form-control" value="${oldData ? oldData.email || '' : ''}" style="width:250px;" ></td>
            <td><input type="number" name="family_${i}_yearly_income" class="form-control" value="${oldData ? oldData.yearly_income || '' : ''}" required></td>
        `;
