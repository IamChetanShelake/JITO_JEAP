    ...
    <div class="steps-container">
        ...
        <div class="step-content" id="step-8">
                ...
                <div class="form-data">
                    ...
                    <div class="data-group">
                        ...
                        <div class="form-section">
                            @if ($pdcDetail->first_cheque_image)
                                ...
                                <div style="margin-top: 1rem; display: flex; flex-direction: column; gap: 1rem;">
                                    @if (in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                        <!-- Image Preview -->
                                        <div
                                            style="display: flex; gap: 1rem; align-items: center; padding: 1rem; border: 2px solid var(--border-color); border-radius: 8px; background: #f8f9fa;">
                                            <div style="flex: 1;">
                                                <img src="{{ $chequeImageUrl }}" alt="First Cheque Image"
                                                    style="max-width: 100%; max-height: 300px; border-radius: 6px; border: 1px solid #dee2e6; object-fit: contain;"
                                                    onclick="openModal('{{ $chequeImageUrl }}', 'First Cheque Image')"
                                                    style="cursor: pointer;">
                                            </div>
                                            <div
                                                style="flex: 0 0 200px; display: flex; flex-direction: column; gap: 0.5rem;">
                                                <button
                                                    onclick="openChequeModal('{{ $chequeImageUrl }}', 'First Cheque Image')"
                                                    style="padding: 0.75rem 1rem; background: var(--primary-purple); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
                                                    <i class="fas fa-expand"></i> View Full Size
                                                </button>
                                                <a href="{{ $chequeImageUrl }}"
                                                    download="first_cheque_image.{{ $fileExtension }}"
                                                    style="padding: 0.75rem 1rem; background: var(--primary-green); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                    ...
                                    @elseif($fileExtension == 'pdf')
                                        ...
                                        <div
                                            ...
                                            <div style="flex: 1;">
                                                <div
                                                    style="display: flex; align-items: center; gap: 1rem; padding: 1rem; background: white; border-radius: 6px; border: 1px solid #dee2e6;">
                                                    <i class="fas fa-file-pdf"
                                                        style="font-size: 3rem; color: #dc3545;"></i>
                                                    <div>
                                                        <a href="{{ $chequeImageUrl }}" target="_blank"
                                                            style="padding: 0.75rem 1rem; background: var(--primary-purple); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                                            <h4 style="margin: 0; ">First Cheque PDF</h4>
                                                        </a>
                                                        <p style="margin: 0.5rem 0 0 0; color: var(--text-light);">Click to
                                                            view or download</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <a href="{{ $chequeImageUrl }}" download="first_cheque_image.pdf"
                                                    style="padding: 0.75rem 1rem; background: var(--primary-green); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                                    ...
                                    @else
                                        <div
                                            style="padding: 1rem; border: 2px solid var(--border-color); border-radius: 8px; background: #f8f9fa;">
                                            <div style="display: flex; align-items: center; gap: 1rem;">
                                                <i class="fas fa-file"
                                                    style="font-size: 2rem; color: var(--text-light);"></i>
                                                <div>
                                                    <h4 style="margin: 0; color: var(--text-dark);">Unsupported File Format
                                                    </h4>
                                                    <p style="margin: 0.5rem 0 0 0; color: var(--text-light);">File
                            ...
                            @else
                                <div
                                    style="padding: 1rem; border: 2px dashed var(--border-color); border-radius: 8px; background: #f8f9fa; text-align: center;">
                                    <i class="fas fa-image"
                                        style="font-size: 3rem; color: var(--text-light); margin-bottom: 1rem;"></i>
                                    <p style="color: var(--text-light); margin: 0;">No cheque image uploaded</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="data-group">
                        ...
                        <div class="step-header"
                            style="margin-bottom: 1rem; border-bottom: none; background: transparent;">
                            <div class="action-buttons">
                                <a href="{{ route('admin.pdc.edit', $user) }}" class="btn-approve"
                                    style="background: var(--primary-green); color: white; text-decoration: none; padding: 0.5rem 1rem; border-radius: 6px; font-weight: 500; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 0.5rem;">
                                    <i class="fas fa-edit"></i> Edit Cheque Details
                                </a>
                            </div>
                        </div>
                        <div class="table-container">
                                ...
                                <table class="custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($chequeDetails as $index => $cheque)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $cheque['parents_jnt_ac_name'] ?? 'N/A' }}</td>
            ...
            @elseif(
                ...
                @if (session('success'))
                    <div
                        style="background: rgba(76, 175, 80, 0.1); border: 1px solid rgba(76, 175, 80, 0.2); border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem;">
                        <p style="color: var(--primary-green); margin: 0; font-size: 0.9rem;">✅ {{ session('success') }}
                        </p>
                    </div>
                @endif
...
<script>
    ...
    // Dedicated function for cheque image modal
    function openChequeModal(url, title = 'Cheque Image') {
