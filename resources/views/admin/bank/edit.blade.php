...
@section('title', 'Edit Bank - JitoJeap Admin')
...
<div class="edit-card">
    <div class="edit-header">
        <h1><i class="fas fa-edit me-2"></i> Edit Bank</h1>
        <p class="subtitle">Update bank information</p>
    </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror"
                               id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code', $bank->ifsc_code) }}">
                        @error('ifsc_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
