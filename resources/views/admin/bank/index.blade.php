...
@section('title', 'Bank Management - JitoJeap Admin')
...
<div class="page-header">
    <div class="page-title-section">
        ...
        <p class="page-subtitle">Manage banks</p>
    </div>
    <a href="{{ route('admin.banks.create') }}" class="add-btn">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 70%;">Bank Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions-cell">
                            ...
                            <form action="{{ route('admin.banks.destroy', $bank) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="3" class="empty-state">
                            ...
                            <p>No banks found. Click "Add Bank" to get started.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
