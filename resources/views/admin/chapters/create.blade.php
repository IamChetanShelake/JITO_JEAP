...
@section('title', 'Add Chapter - JitoJeap Admin')

@section('content')
<div class="page-header mb-4">
    <h1 class="page-title" style="color: #393185;">Add Chapter</h1>
    <p class="page-subtitle">Add a new chapter</p>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('chapter_head') is-invalid @enderror" 
                           id="chapter_head" name="chapter_head" value="{{ old('chapter_head') }}" required>
                    @error('chapter_head')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
