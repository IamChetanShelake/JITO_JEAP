...
@section('title', 'Create Chapter - JitoJeap Admin')

@section('content')
<div class="section-card">
    <div class="card-header">
        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i> Create New Chapter</h4>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('chairman') is-invalid @enderror" 
                           id="chairman" name="chairman" value="{{ old('chairman') }}" required>
                    @error('chairman')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('contact_no') is-invalid @enderror" 
                           id="contact_no" name="contact_no" value="{{ old('contact_no') }}" required>
                    @error('contact_no')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
