...
<div class="page-header">
    <div class="page-title-section">
        <h1 class="page-title">
            <i class="fas fa-book" style="color: var(--primary-purple); margin-right: 0.5rem;"></i>
            Chapter Management
        </h1>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 15%;">Chapter Head</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions-cell">
                            <a href="{{ route('admin.chapters.show', $chapter) }}" class="action-btn view-btn">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.chapters.edit', $chapter) }}" class="action-btn edit-btn">
                    ...
                    <tr>
                        <td colspan="12" class="empty-state">
                            ...
                            <p>No chapters found. Click "Add Chapter" to get started.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
