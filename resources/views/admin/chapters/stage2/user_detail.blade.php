                            ...
                            <form action="{{ route('admin.user.approve', ['user' => $user, 'stage' => 'chapter']) }}"
                                ...
                                <div class="form-row" style="margin-bottom: 1rem;">
                                    <div class="form-field form-field-full">
                                        ...
                                        <input type="text" class="form-input" value="{{ $data->group_4_total }}"
                                            readonly
                                            style="border: 2px solid #4CAF50; background: rgba(76, 175, 80, 0.05);">
                                    </div>
                                </div>
...
<script>
    ...
    const interviewQuestions = [
        "What motivated you to pursue higher education abroad?",
        ...
        "How familiar are you with the culture and lifestyle in your destination country?",
        "What challenges do you anticipate facing during your studies abroad?",
        "How will you handle homesickness and cultural adaptation?",
        "What extracurricular activities or leadership roles have you been involved in?",
        "How do you plan to contribute to your community upon return?",
        "What backup plans do you have if your application is not successful?",
        "How have you prepared for the academic rigor of international education?",
        "What language proficiency do you have for your study destination?",
        "How do you plan to maintain contact with your family and support system?",
        "What research have you done about living costs and accommodation?",
        "How confident are you in managing your finances independently?"
    ];
