                                ...
                                <div class="modal fade" id="disburseModal{{ $schedule->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.disbursement.store') }}" method="POST"
                                                id="disburseForm{{ $schedule->id }}">
                                                @csrf
                                                <div class="modal-body">
                                                    <input type="hidden" name="disbursement_schedule_id"
                                                        value="{{ $schedule->id }}">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                name="disbursement_date" value="{{ date('Y-m-d') }}"
                                                                required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" name="amount"
                                                                value="{{ $schedule->planned_amount }}" step="0.01"
                                                                min="0" max="{{ $schedule->planned_amount }}"
                                                                required>
                                                            <small class="text-muted">Max:
                                                                ₹{{ number_format($schedule->planned_amount, 2) }}</small>
                                                        </div>

                                                        <!-- Source Bank Account -->
                                                        <div class="col-md-6">
                                                            <label class="form-label">Source Bank Account <span
                                                                    class="text-danger">*</span></label>
                                                        ...
                                                        <!-- UTR Number -->
                                                        <div class="col-md-6">
                                                            <label class="form-label">UTR Number <span
                                                                    class="text-danger">*</span></label>
                    ...
                    fetch(form.action, {
                        ...
                        .then(response => {
                            ...
                            return response.text().then(text => {
                                ...
                                try {
                                    ...
                                    throw new Error('Invalid JSON response: ' + text.substring(
                                        0, 200));
                                }
                            });
                        })
                        ...
                        .catch(error => {
                            ...
                            Swal.fire({
                                ...
                                title: 'Warning',
                                text: error.message +
                                    '. If the disbursement was stored, the page will reload.',
                                timer: 3000,
