                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select name="personal_detail[title]" class="form-select">
                                    <option value="Mr"
                                        {{ ($donor->personalDetail->title ?? '') == 'Mr' ? 'selected' : '' }}>Mr</option>
                                    <option value="Mrs"
                                        {{ ($donor->personalDetail->title ?? '') == 'Mrs' ? 'selected' : '' }}>Mrs</option>
                                    <option value="Ms"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="personal_detail[middle_name]" class="form-control"
                                    value="{{ $donor->personalDetail->middle_name ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <div class="info-label">Surname</div>
                                <input type="text" name="personal_detail[surname]" class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="personal_detail[city]" class="form-control"
                                    value="{{ $donor->personalDetail->city ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <div class="info-label">State</div>
                                <input type="text" name="personal_detail[state]" class="form-control"
                                    value="{{ $donor->personalDetail->state ?? '' }}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="personal_detail[blood_group]" class="form-control"
                                    value="{{ $donor->personalDetail->blood_group ?? '' }}">
                            </div>
                        </div>
                    ...
                    <div class="step-content-section" id="step-2">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="family_detail[spouse_name]" class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="family_detail[number_of_kids]" class="form-control"
                                    value="{{ $donor->familyDetail->number_of_kids ?? '' }}">
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @if (isset($children) && count($children) > 0)
                                            @foreach ($children as $i => $child)
                                                <tr>
                                                    <td><input type="text" name="children[{{ $i }}][name]"
                                                            class="form-control form-control-sm"
                                                            value="{{ $child['name'] ?? '' }}"></td>
                                                    <td>
                                                        <select name="children[{{ $i }}][gender]"
                                                    ...
                                                    <td><input type="date" name="children[{{ $i }}][dob]"
                                                            class="form-control form-control-sm"
                                                            value="{{ $child['dob'] ?? '' }}"></td>
                                                    <td><input type="text"
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td><select name="children[0][gender]" class="form-select form-select-sm">
                                                        <option>Male</option>
                    ...
                    <div class="step-content-section" id="step-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nominee_detail[nominee_name]" class="form-control"
                                    value="{{ $donor->nomineeDetail->nominee_name ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <div class="info-label">Relationship</div>
                                <input type="text" name="nominee_detail[nominee_relationship]" class="form-control"
                    ...
                    <div class="step-content-section" id="step-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="professional_detail[company_name]" class="form-control"
                                    value="{{ $donor->professionalDetail->company_name ?? '' }}">
                            </div>
                            <div class="col-md-6">
                                <div class="info-label">Designation</div>
                                <input type="text" name="professional_detail[designation]" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                @if (!empty($donor->document?->pan_member_file))
                                    <div class="current-file">Current: <a
                                            href="{{ asset($donor->document->pan_member_file) }}" target="_blank">View
                                            File</a></div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                ...
                                @if (!empty($donor->document?->photo_file))
                                    <div class="current-file">Current: <a
                                            href="{{ asset($donor->document->photo_file) }}" target="_blank">View
                                            File</a></div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                ...
                                @if (!empty($donor->document?->address_proof_file))
                                    <div class="current-file">Current: <a
                                            href="{{ asset($donor->document->address_proof_file) }}" target="_blank">View
                                            File</a></div>
                                @endif
                            </div>
                        </div>
