...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1 class="page-title">Initiative Management</h1>
...
<div class="data-table">
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $index + 1 }}</td>
                <td><strong>{{ $initiative->initiative_leader }}</strong></td>
                <td>
                    <span class="badge bg-light text-dark border">{{ $initiative->initiative_name }}</span>
                </td>
