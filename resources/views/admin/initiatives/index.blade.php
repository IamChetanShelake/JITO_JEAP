...
<div class="page-header">
    <div class="page-title-section">
        <h1 class="page-title">
            <i class="fas fa-lightbulb" style="color: var(--primary-green); margin-right: 0.5rem;"></i>
    ...
    <div class="table-container">
        <div class="table-responsive">
            <div class="scroll-hint">
                <i class="fas fa-chevron-right" style="color: var(--primary-green);"></i>
            </div>
            <table class="table">
                <thead>
                    <tr>
                        <th style="width: 5%;">Seq</th>
                        <th style="width: 15%;">Initiative Leader</th>
                        <th style="width: 20%;">Initiative Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>
                            <strong>{{ $initiative->initiative_leader }}</strong>
                        </td>
                        <td>
                            <div class="initiative-name">
                                <div class="initiative-icon" style="background-color: var(--primary-green);">
                                    @if($initiative->initiative_name)
                                        {{ strtoupper(substr($initiative->initiative_name, 0, 1)) }}
                                    @endif
                                </div>
                                <span>{{ $initiative->initiative_name }}</span>
                            </div>
                        </td>
                        <td>{{ $initiative->designation }}</td>
                        <td>{{ $initiative->email }}</td>
                        <td>{{ $initiative->contact }}</td>
                        <td>
                            <span class="status-badge status-{{ $initiative->status ? 'active' : 'inactive' }}">
                        ...
                        <td class="actions-cell">
                            <a href="{{ route('admin.initiatives.show', $initiative) }}" class="action-btn view-btn">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.initiatives.edit', $initiative) }}" class="action-btn edit-btn">
                    ...
                    <tr>
                        <td colspan="9" class="empty-state">
                            ...
                            <p>No initiatives found. Click "Add Initiatives" to get started.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
