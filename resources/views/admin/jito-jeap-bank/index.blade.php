                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions-cell">
                            <a href="{{ route('admin.jito-jeap-banks.edit', $bank) }}" class="action-btn edit-btn" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.jito-jeap-banks.destroy', $bank) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
