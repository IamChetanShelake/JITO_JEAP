...
@section('title', 'Add Subcast - JitoJeap Admin')
...
<div class="create-card">
    <div class="create-header">
        <h1><i class="fas fa-users me-2"></i> Add Subcast</h1>
        <p class="subtitle">Create a new subcast</p>
    </div>

    <div class="create-card-body">
        <form action="{{ route('admin.subcasts.store') }}" method="POST">
            @csrf
            ...
            <div class="action-buttons">
                <button type="submit" class="btn-custom">
                    <i class="fas fa-save me-2"></i> Save Subcast
                </button>
