        ...
        <div class="table-container">
            <div class="table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @php
                            $users = \App\Models\User::with('workflowStatus')
                                ->where('role', 'user')
                        ...
                        @forelse($users as $index => $user)
                            <tr>
                                ...
                                <td>{{ $user->workflowStatus ? ucfirst(str_replace('_', ' ', $user->workflowStatus->current_stage)) : 'N/A' }}
                                </td>
                                <td>
                                ...
                                <td class="">
                                    <a href="{{ route('admin.user.detail', $user) }}" class="action-btn view-btn"
                                        title="View Details">
