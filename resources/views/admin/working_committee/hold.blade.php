...
@section('title', 'Working Committee - Hold Forms - JitoJeap Admin')
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                } elseif ($user->workflowStatus && $user->workflowStatus->working_committee_reject_remarks) {
                                    $status = 'Resubmitted';
                                    $statusClass = 'status-hold';
                            ...
                            @if($user->workflowStatus && $user->workflowStatus->working_committee_reject_remarks)
                                <div class="hold-reason">Reason: {{ $user->workflowStatus->working_committee_reject_remarks }}</div>
                            @else
                                <div class="hold-reason">Reason: Rejected at Working Committee stage</div>
                            @endif
                        </td>
