...
@section('content')
        ...
        <div class="container-fluid" style="min-height:100vh; display:flex; align-items:center; justify-content:center; background-color:#fff;">
            <div class="row w-100 justify-content-center align-items-center mt-4">
                ...
                <div class="col-md-5 offset-md-1 mb-5 mb-md-0 text-start">
                    ...
                    <h4 class="fw-bold mb-3" style="font-size:25px;font-weight:500;color:#4C4C4C;">Verify Your Identity
                    </h4>
                    <p class="text-muted mb-4" style="font-size:19px;font-weight:500; text-align:justify;">
                        We've sent a 6-digit OTP to your email. Enter the OTP to verify your identity and reset your password.
                    </p>
                    ...
                    <div class="card shadow-md border-0 p-4 rounded-4"
                        ...
                        <div class="card-body">
                            <h4 class="fw-semibold mb-1 text-start" style="font-size:28px; font-weight:500;color:#4C4C4C;">
                                Verify OTP</h4>
                            <p class="text-muted text-start mb-4" style="font-size:19px;">Enter the OTP sent to your email</p>
                            ...
                            <!-- Error Message -->
                            @if ($errors->any())
                                <div class="alert alert-danger mb-4" style="border-radius: 10px; padding: 15px; background: #f8d7da; border: 1px solid #f5c6cb; color: #721c24;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="me-2" viewBox="0 0 16 16">
                            ...
                            <form method="POST" action="{{ route('password.verifyotp') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="email" value="{{ session('email') ?? old('email') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input id="otp" type="text" name="otp" maxlength="6"
                                            ...
                                            value="{{ old('otp') }}" placeholder="000000" required autocomplete="off">
                                    </div>
                                    @error('otp')
                                ...
                                <div class="info-box">
                                    <p style="font-size: 14px; color: #6C6C6C; margin: 0;">
                                        <strong>Note:</strong> OTP is valid for 10 minutes. If you didn't receive the email, check your spam folder.
                                    </p>
                                </div>
                                ...
                                <div class="d-grid mt-2">
                                    <button type="submit" class="btn btn-primary fw-semibold"
                                        style="background-color:#3E2B87; border:none;font-size:17px;">Verify OTP</button>
                                </div>

                                <!-- Resend OTP -->
                                <div class="text-center mt-3">
                                    <p class="mb-2" style="font-size: 14px; color: #666;">Didn't receive the OTP?</p>
                                    <form method="POST" action="{{ route('password.resendotp') }}" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="email" value="{{ session('email') ?? old('email') }}">
                                        <button type="submit" class="btn btn-link text-decoration-none" style="color:#3E2B87; font-size: 14px;">Resend OTP</button>
                                    </form>
                                </div>
    ...
    <div class="mobile-forgot-container d-lg-none">
        ...
        <div class="mobile-form-container">
            <h3 class="mobile-form-title">Verify OTP</h3>
            <p class="mobile-form-subtitle">Enter the OTP sent to your email</p>
            ...
            <form method="POST" action="{{ route('password.verifyotp') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-box">
                        ...
                        <input id="otp-mobile" type="text" name="otp" maxlength="6"
                            class="form-control otp-input @error('otp') is-invalid @enderror"
                            value="{{ old('otp') }}" placeholder="000000" required autocomplete="off">
                    </div>
                    @error('otp')
                ...
                <button type="submit" class="btn-send">Verify OTP</button>

                <!-- Resend OTP -->
                <div class="text-center mt-3">
                    <p class="mb-2" style="font-size: 13px; color: #666;">Didn't receive the OTP?</p>
                    <form method="POST" action="{{ route('password.resendotp') }}" class="d-inline">
                        @csrf
                        <input type="hidden" name="email" value="{{ session('email') ?? old('email') }}">
                        <button type="submit" class="btn btn-link text-decoration-none p-0" style="color:#3E2B87; font-size: 13px;">Resend OTP</button>
                    </form>
                </div>
