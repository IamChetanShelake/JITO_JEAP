...
<div class="mb-3">
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="checkbox" name="payment_options[]" value="54_lakhs">
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="checkbox" name="payment_options[]" value="1_year">
        <label class="form-check-label">
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="checkbox" name="payment_options[]" value="2_year">
        <label class="form-check-label">
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="checkbox" name="payment_options[]" value="3_year">
        <label class="form-check-label">
