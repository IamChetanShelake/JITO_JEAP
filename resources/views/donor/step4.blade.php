                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="payment_options[]"
                                            value="54_lakhs"
                                            {{ in_array('54_lakhs', $selectedPayments, true) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="payment_options[]"
                                            value="1_year"
                                            {{ in_array('1_year', $selectedPayments, true) ? 'checked' : '' }}>
                                        <label class="form-check-label">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="payment_options[]"
                                            value="2_year"
                                            {{ in_array('2_year', $selectedPayments, true) ? 'checked' : '' }}>
                                        <label class="form-check-label">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="payment_options[]"
                                            value="3_year"
                                            {{ in_array('3_year', $selectedPayments, true) ? 'checked' : '' }}>
                                        <label class="form-check-label">
