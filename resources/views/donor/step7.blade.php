        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><input type="text" name="utr_no[]" class="form-control"></td>
                        <td><input type="date" name="cheque_date[]" class="form-control"></td>
                        <td><input type="number" name="amount[]" class="form-control"></td>
                        <td><input type="text" name="bank_branch[]" class="form-control"></td>
                        <td><input type="text" name="issued_by[]" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td><input type="text" name="utr_no[]" class="form-control"></td>
