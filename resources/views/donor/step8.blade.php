...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <form method="POST" action="{{ route('donor.step8.store') }}">
                        ...
                        <div class="form-group mt-4 p-3"
                            ...
                            <p>
                                1. I agree to abide by the Code of Conduct and Memorandum & Articles of Association of JITO
                                Education Assistance Foundation.<br>
                                2. I I also agree to the condition that the contribution towards Membership fee shall be
                                purely in the nature of donation. I am also aware that as per the provisions of the
                                Memorandum of Association and the Articles of Association of the JITO Education Assistance
                                Foundation, a Member is not eligible for any benefit, monetary or of any other kind, from
                                the Company (JITO Education Assistance Foundation), and no such benefit can be demanded by
                                the Member. <br>
                                3. I also hereby agree to receive all communications on my email ID and mobile no.
                                registered with JITO Education Assistance Foundation.
                            </p>
    ...
    <script>
        @if (session('success') && session('application_completed'))
