                    ...
                    <tr>
                        <td style="padding: 24px; color: #333333;">
                            ...
                            <p style="margin: 0 0 12px;">
                                Your registration has been completed successfully by the admin.
                            </p>
                            <p style="margin: 0 0 6px;"><strong>Login Email:</strong> {{ $user->email }}</p>
                            <p style="margin: 0 0 12px;"><strong>Password:</strong> {{ $plainPassword }}</p>
                            <p style="margin: 0 0 12px;">
