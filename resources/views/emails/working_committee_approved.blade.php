...
<head>
    ...
    <title>Working Committee Approved</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 32px 24px; color: #333333;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.5;">
                                <strong>Congratulations!</strong> Your application has been approved by the Working Committee.
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="color: #6c757d; font-size: 14px;">Approved Amount:</span>
                                                </td>
                                                <td style="padding: 8px 0; text-align: right;">
                                                    <span style="color: #4CAF50; font-size: 14px; font-weight: 600;">
                                                        @php
                                                            $wca = $user->workingCommitteeApproval;
                                                            $amount = $wca ? $wca->approval_financial_assistance_amount : 0;
                                                        @endphp
                            ...
                            <p style="margin: 0 0 24px; font-size: 14px; line-height: 1.5; color: #666666;">
                                Please find the attached Sanction Letter with all the details regarding your approved financial assistance.
                            </p>
