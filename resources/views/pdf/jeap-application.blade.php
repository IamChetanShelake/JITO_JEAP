...
<body>
    ...
    <div class="form-info">
        <div class="form-row">
            ...
            <div class="form-value">{{ str_pad($user->application_no, 4, '0', STR_PAD_LEFT) }}</div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="form-value">
                {{ $user->financial_asset_type == 'domestic' ? 'DOMESTIC' : 'FOREIGN FINANCIAL ASSISTANCE' }}</div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <p><strong>** I/We hereby give consent to my Son / Daughter to apply for the Educational Assistance.</strong>
        </p>
    ...
    <style>
        ...
        .info-box+.info-box {
            border-top: none;
            /* Optional: merge borders for continuous look */
        }
    ...
    <div class="section">
        ...
        <p><strong>Please specify if any extra curricular activities at school/college/University level:</strong>
            {{ $educationDetail->extra_curricular ?? 'N/A' }}</p>
        <p><strong>Please specify if any research and development projects undertaken:</strong>
            {{ $educationDetail->projects ?? 'N/A' }}</p>
        <p><strong>Please specify work experience if any:</strong>
            {{ $educationDetail->have_work_experience == 'yes' ? $educationDetail->work_duration . ' years' : 'None' }}
        </p>
    ...
    <div class="section">
        ...
        <p><strong>Requested Year: 1st Year Amount Requested tuition fees amount:</strong>
            {{ number_format($educationDetail->group_1_year1 ?? 0, 2) }}</p>
            ...
            <tbody>
                @if ($fundingDetail)
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <strong>{{ number_format($fundingDetail->total_funding_amount ?? 0, 2) }}</strong></td>
                    </tr>
                @endif
            </tbody>
        </table>

        <p><strong>As on today is there any unpaid Educational Assistance of JITO by you or your family members? if
                yes</strong> {{ $fundingDetail->unpaid_assistance ?? 'No' }}</p>
    </div>
    ...
    <style>
        ...
        .signature-cell:first-child {
            border-left: none;
            /* no double border on leftmost cell */
        }
    ...
    <div class="section declaration">
        ...
        <div class="info-box">
            <p>
                ...
                I hereby give my consent to my son / daughter / ward for going to:
                {{ $educationDetail->course_name ?? 'N/A' }} for further studies.
            </p>
        </div>
        ...
        <div class="info-box">
            <p>
                If my Educational Assistance is approved, I agree to abide by the terms and conditions of the JEAP
                EDUCATION ASSISTANCE PROGRAM.
                I also undertake to keep the office bearers/Trustees informed of my correct address and that of my
                Parents/Guarantors and recommenders from time to time.
