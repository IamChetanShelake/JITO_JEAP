                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="number" class="form-control" name="number_family_members"
                                                ...
                                                value="{{ old('number_family_members', $familyDetail->number_family_members ?? '') }}" required>
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="number" class="form-control" name="total_family_income"
                                                ...
                                                value="{{ old('total_family_income', $familyDetail->total_family_income ?? '') }}" required>
                                            <small class="text-danger">{{ $errors->first('total_family_income') }}</small>
                                        </div>
                                        <div class="form-group mb-3">
                                            <input type="number" class="form-control" name="total_students"
                                                placeholder="Total Number of Students *" value="{{ old('total_students', $familyDetail->total_students ?? '') }}"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="number" class="form-control" name="total_insurance_coverage"
                                                ...
                                                value="{{ old('total_insurance_coverage', $familyDetail->total_insurance_coverage ?? '') }}" required>
                                            <small
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="number" class="form-control" name="total_premium_paid"
                                                ...
                                                value="{{ old('total_premium_paid', $familyDetail->total_premium_paid ?? '') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="father_name"
                                                        placeholder="Father's Name *" value="{{ old('father_name', $familyDetail->father_name ?? '') }}"
                                                        required>
                                                    <small class="text-danger">{{ $errors->first('father_name') }}</small>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="number" class="form-control" name="father_age"
                                                        placeholder="Age *" value="{{ old('father_age', $familyDetail->father_age ?? '') }}" required
                                                        min="18" max="120">
                                                ...
                                                <div class="form-group mb-3">
                                                    <select class="form-control" name="father_marital_status" required>
                                                        <option disabled
                                                            {{ (old('father_marital_status') ?: $familyDetail->father_marital_status ?? '') ? '' : 'selected' }} hidden>
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('father_qualification', $familyDetail->father_qualification ?? '') }}" required>
                                                    <small
                                                        class="text-danger">{{ $errors->first('father_qualification') }}</small>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="father_occupation"
                                                        placeholder="Occupation *" value="{{ old('father_occupation', $familyDetail->father_occupation ?? '') }}"
                                                        required>
                                                    <small
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control" name="father_mobile"
                                                        placeholder="Mobile Number *" value="{{ old('father_mobile', $familyDetail->father_mobile ?? '') }}"
                                                        required>
                                                    <small
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="number" class="form-control"
                                                        ...
                                                        value="{{ old('father_yearly_gross_income', $familyDetail->father_yearly_gross_income ?? '') }}" required>
                                                    <small
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="mother_name"
                                                        placeholder="Mother's Name *" value="{{ old('mother_name', $familyDetail->mother_name ?? '') }}"
                                                        required>
                                                    <small class="text-danger">{{ $errors->first('mother_name') }}</small>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="number" class="form-control" name="mother_age"
                                                        placeholder="Age *" value="{{ old('mother_age', $familyDetail->mother_age ?? '') }}" required
                                                        min="18" max="120">
                                                ...
                                                <div class="form-group mb-3">
                                                    <select class="form-control" name="mother_marital_status" required>
                                                        <option disabled
                                                            {{ (old('mother_marital_status') ?: $familyDetail->mother_marital_status ?? '') ? '' : 'selected' }} hidden>
                                                            Marital Status *</option>
                                                        <option value="married"
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('mother_qualification', $familyDetail->mother_qualification ?? '') }}" required>
                                                    <small
                                                        class="text-danger">{{ $errors->first('mother_qualification') }}</small>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="mother_occupation"
                                                        placeholder="Occupation *" value="{{ old('mother_occupation', $familyDetail->mother_occupation ?? '') }}"
                                                        required>
                                                    <small
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control" name="mother_mobile"
                                                        placeholder="Mobile Number *" value="{{ old('mother_mobile', $familyDetail->mother_mobile ?? '') }}"
                                                        required>
                                                    <small
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="number" class="form-control"
                                                        ...
                                                        value="{{ old('mother_yearly_gross_income', $familyDetail->mother_yearly_gross_income ?? '') }}" required>
                                                    <small
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="has_sibling" value="yes"
                                                            id="has_sibling_yes"
                                                            {{ (old('has_sibling') ?: $familyDetail->has_sibling ?? 'no') == 'yes' ? 'checked' : '' }}> <label
                                                ...
                                                <div id="sibling-fields" style="display: none;">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <input type="text" class="form-control" name="sibling_name_1"
                                                            placeholder="Name *" value="{{ old('sibling_name_1', $familyDetail->sibling_name_1 ?? '') }}">
                                                        <small
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="paternal_uncle_name"
                                                        placeholder="Paternal Uncle's Name" value="{{ old('paternal_uncle_name', $familyDetail->paternal_uncle_name ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control"
                                                        name="paternal_uncle_mobile" placeholder="His Mobile Number" value="{{ old('paternal_uncle_mobile', $familyDetail->paternal_uncle_mobile ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="email" class="form-control"
                                                        name="paternal_uncle_email" placeholder="His Email Address" value="{{ old('paternal_uncle_email', $familyDetail->paternal_uncle_email ?? '') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="paternal_aunt_name"
                                                        placeholder="Paternal Aunt's Name" value="{{ old('paternal_aunt_name', $familyDetail->paternal_aunt_name ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control"
                                                        name="paternal_aunt_mobile" placeholder="Her Mobile Number" value="{{ old('paternal_aunt_mobile', $familyDetail->paternal_aunt_mobile ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="email" class="form-control" name="paternal_aunt_email"
                                                        placeholder="Her Email Address" value="{{ old('paternal_aunt_email', $familyDetail->paternal_aunt_email ?? '') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="maternal_uncle_name"
                                                        placeholder="Maternal Uncle's Name" value="{{ old('maternal_uncle_name', $familyDetail->maternal_uncle_name ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control"
                                                        name="maternal_uncle_mobile" placeholder="His Mobile Number" value="{{ old('maternal_uncle_mobile', $familyDetail->maternal_uncle_mobile ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="email" class="form-control"
                                                        name="maternal_uncle_email" placeholder="His Email Address" value="{{ old('maternal_uncle_email', $familyDetail->maternal_uncle_email ?? '') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control" name="maternal_aunt_name"
                                                        placeholder="Maternal Aunt's Name" value="{{ old('maternal_aunt_name', $familyDetail->maternal_aunt_name ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control"
                                                        name="maternal_aunt_mobile" placeholder="Her Mobile Number" value="{{ old('maternal_aunt_mobile', $familyDetail->maternal_aunt_mobile ?? '') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <input type="email" class="form-control" name="maternal_aunt_email"
                                                        placeholder="Her Email Address" value="{{ old('maternal_aunt_email', $familyDetail->maternal_aunt_email ?? '') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
