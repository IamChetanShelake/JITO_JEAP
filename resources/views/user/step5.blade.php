        ...
        function checkDuplicate(field, value, errorElementId) {
            ...
            fetch("{{ route('user.check.guarantor.duplicate') }}", {
                ...
                .then(data => {
                    ...
                    if (field === 'pan') {
                        if (data.source === 'user') {
                            errorEl.innerText = "This PAN is already used in users.";
                        } else if (data.source === 'guarantor') {
                            errorEl.innerText = "This PAN is already used in guarantor details.";
                        } else {
                            errorEl.innerText =
                                "This PAN cannot be the same as the applicant or a family member.";
                        }
                        return;
                    }
