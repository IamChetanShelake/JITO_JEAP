                ...
                <div class="col-12">
                    <form method="POST" action="{{ route('user.step6.storeforeign') }}" enctype="multipart/form-data"
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        <div class="col-9">
                                                            <span class="photo-label">Passport of Applicant
                                                                *<br></span>
                                                            <span class="photo-label"
                                                                style="color:gray;font-size:12px;">Need front and back side
                                                                of Passport.
                                                            </span>
                                                            <input type="file" id="passport_applicant"
                                                                name="passport_applicant" hidden
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        <div class="col-9">
                                                            <span class="photo-label">Visa of Applicant
                                                                *<br></span>
                                                            <span class="photo-label"
                                                                style="color:gray;font-size:12px;">If
                        ...
                        <div class="d-flex justify-content-between mt-4 mb-4">
                            ...
                            @else
                                <button type="submit" class="btn" style="background:#393185;color:white;">Next
                                    Step <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
