                                    ...
                                    <div style="margin-top: 32px;padding:0 20px;">
                                        ...
                                        <div class="row" style="margin-top: 16px;color:#393185;">
                                            ...
                                            <div class="col-4 col-md-2" style="text-align: center; color:#393185;">
                                                <a href="" style="text-decoration: none; color: inherit;">
                                                    <div
                                                        style="width: 60px; height: 60px; border: 3px solid #393185; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 8px; transition: background-color 0.3s;font-size:24px;margin-bottom:20px; @if ($useDocumentsBelow ? ($user->documentsBelow && $user->documentsBelow->submit_status == 'submited') : ($useDocumentBelowPg ? ($user->documentBelowPg && $user->documentBelowPg->submit_status == 'submited') : ($user->document && $user->document->submit_status == 'submited'))) background-color: green;color:white; @elseif ($useDocumentsBelow ? ($user->documentsBelow && $user->documentsBelow->submit_status == 'resubmit') : ($useDocumentBelowPg ? ($user->documentBelowPg && $user->documentBelowPg->submit_status == 'resubmit') : ($user->document && $user->document->submit_status == 'resubmit'))) background-color: red;color:white; @elseif ($useDocumentsBelow ? ($user->documentsBelow && $user->documentsBelow->submit_status == 'approved') : ($useDocumentBelowPg ? ($user->documentBelowPg && $user->documentBelowPg->submit_status == 'approved') : ($user->document && $user->document->submit_status == 'approved'))) background-color: orange;color:white; @endif">
                                                        {{ !$isBelowOneLakh ? '6' : '5' }}
                                                    </div>
